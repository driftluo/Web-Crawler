...
driver = webdriver.PhantomJS(
    executable_path=r'E:\webdriver\phantomjs-2.1.1-windows\bin\phantomjs')
...
def findNewUpdate(bookname):
    ...
    f = driver.find_element_by_xpath(
        '//*[@id="result-list"]/div/ul/li[1]/div[2]/h4/a').click()
    ...
    name = driver.find_element_by_xpath(
        '/html/body/div[2]/div[6]/div[4]/div[1]/div[2]/ul/li[2]/a').text
    dd = driver.find_element_by_xpath(
        '/html/body/div[2]/div[6]/div[4]/div[1]/div[2]/ul/li[2]/em').text
